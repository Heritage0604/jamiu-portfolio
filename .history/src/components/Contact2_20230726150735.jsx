...
<Flex  width={"80vw"} mt={"5vh"}>
    <Text ml={"20px"} border={"1px solid red"} mr={"10%"} pr={"30px"} height={{bae:"30px",md:"40px"}} borderBottom={"1px solid white"} fontWeight={"300"} fontSize={{base:"15px",md:"25px"}}>WONDERING HOW YOU CAN MAKE THE BEST DECISIONS USING YOUR DATA?</Text>
</Flex>
