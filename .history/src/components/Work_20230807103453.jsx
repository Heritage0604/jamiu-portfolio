...
<Flex flexDirection={"column"} border={"1px solid red"} justify={"center"} mt={"3vh"} width={"100%"} >
...
<SimpleGrid width={'100%'} justify={"center"} mb={"2vh"} columns={2} spacingX='40px' border={"2px solid yellow"} spacingY='20px' minChildWidth='200px' ml={"10%"}>
