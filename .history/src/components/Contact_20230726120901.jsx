...
<Flex mt={"3vh"} flexDirection={"column"}  width={"80%"}>
    ...
    <Text fontSize={base:"13px"} color={"black"}   >we can get in touch via <Link textAlign={"center"} isExternal href={"https://www.linkedin.com/in/jamiu-gbadamosi-ba342326a"} _hover={{color:"blue"}} color={"blue"}>LinkedIn  <Icon color={"blue"} ml={"0px"} as={BsLinkedin}/></Link>
    </Text>
