...
<Flex ml={"10px"} mr={"10px"} justify={{base:"space-between",md:"space-around"}} width={"80vw"} >  
    <Flex>
        <Image src={p1}  width={{base:"150px",md:"150px"}} />
    </Flex>
    <Flex ml={"10px"}>
          <Image src={p2} width={{base:"150px",md:"150px"}}  />
    </Flex>
</Flex>
<Flex mt={"2vh"} ml={"10px"} mr={"10px"} justify={{base:"space-between",md:"space-around"}} width={"80vw"} >  
    <Flex>
        <Image src={p3}  width={{base:"150px",md:"150px"}} />
    </Flex>
    <Flex ml={"10px"}>
          <Image src={p4} width={{base:"150px",md:"150px"}}  />
    </Flex>
</Flex>
