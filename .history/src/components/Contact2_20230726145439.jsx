...
<Flex width={"80%"} mt={"5vh"}>
    <Text pr={"30px"} height={{bae:"30px",md:"40px"}} borderBottom={"1px solid white"} fontWeight={"300"} fontSize={{base:"15px",md:"25px"}}>WONDERING HOWn YOU CAN MAKE THE BEST DECISIONS USING YOUR DATA?</Text>
</Flex>
