...
<Flex  width={"100vw"} mt={"5vh"}>
    <Text pr={"30p ml={"10%x"} height={{bae:"30px",md:"40px"}} borderBottom={"1px solid white"} fontWeight={"300"} fontSize={{base:"15px",md:"25px"}}>ABOUT ME</Text>
</Flex>
