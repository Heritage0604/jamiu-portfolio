...
<Flex justify={{base:"space-between",md:"space-around"}} width={"80vw"} border={"1px solid green"}>  
    <Flex>
        <Image src={j2} height={{base:"100px",md:"150px"}} width={{base:"100px",md:"150px"}} />
    </Flex>
    <Flex>
          <Image src={j2} width={{base:"100px",md:"150px"}} height={{base:"100px",md:"150px"}} />
    </Flex>
</Flex>
