...
const Contact2 = () => {
  return (
    ...
    <Flex mt={"-25vh"} flexDirection={"column"} align={"center"} bg={"#627be9eb"}   width={"100%"}>
<Flex  width={"80vw"} mt={"5vh"}>
    <Text mr={"10px"} pr={"30px"} height={{bae:"30px",md:"40px"}} borderBottom={"1px solid white"} fontWeight={"300"} fontSize={{base:"15px",md:"25px"}}>WONDERING HOW YOU CAN MAKE THE BEST DECISIONS USING YOUR DATA?</Text>
</Flex>
