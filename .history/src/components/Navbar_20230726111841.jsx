...
// }
  ...
  return (
   <Flex align={"center"} flexDirection={"column"}>
     <Flex  position={"fixed"} top={"0px"} zIndex={20} border={"1px solid #e8edea "} boxShadow='lg' rounded='md' bg='white' height={"10vh"} align={'center'} width={{base:"117vw",md:"100vw"}} >
...
<Menu>
  ...
  <MenuList>
    ...
    <MenuItem onClick={onTop3}>
      ...
      <Flex justify="center" mt={"15vh"} position={"relative"} height={"80vh"}>
       <Text color={"white"} border={"1px solid white"} height={"px"} borderRadius={"10px"} position={"absolute"} top={"50%"} transform={" translate(-50%, -50%);"} left={"50%"}>Jamiu Data Analyst</Text>
        <Image objectFit='cover' width={{base:"110vw",md:'90vw'}}   src={forest2Logo} alt='forest' />
      </Flex>
