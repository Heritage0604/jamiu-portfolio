...
<SimpleGrid mb={"2vh"} columns={2} spacingX='40px' spacingY='20px' minChildWidth='200px' ml={"10%"}>
  <Link  _hover={{bg:"red"}}  isExternal href={"https://drive.google.com/file/d/14qpjdYNnHDovVgmtH2jdsCHl-ruQo3GE/view?usp=share_link"} position={"relative"}  cursor="pointer" height='180px'>
...
<Link isExternal href={"https://drive.google.com/file/d/1FQHaUvGAeioZZAqBJQoScAWAIFmPCcMt/view?usp=share_link"}>
  <Box  height='180px'>
     <img
            src={p2}
            alt={'Projects'}
  ...
  <Link isExternal href={'https://drive.google.com/file/d/1TO-TfP8U4NU5BQyNQ4j1iTKuT0bmovc8/view?usp=share_link'} height='180px'>
     <img
            src={p3}
            alt={'Projects'}
            className='w-[100%] h-[100%] object-cover'
...
<Link isExternal hre-={"https://drive.google.com/file/d/1PSxjjgPn6svKAMoqojrrmlWtX-zSlK7G/view?usp=share_link"}>
  <Box  height='180px'>
     <img
            src={p4}
            alt={'Projects'}
