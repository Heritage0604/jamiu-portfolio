...
const About = () => {
  return (
   <Flex flexDirection={"column"} align={"center"} bg={"#869af3ec"} border={"1px solid green"} mr={"15%"}   width={"100vw"}>
...
<Flex mb={'2vh'} border={"1px solid red"} width={{base:"100vw",md:"100%"}}><Text ml={"10px"} mr={"10px"} color={"white"}>
